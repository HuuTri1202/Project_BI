              ...
              <Td align="right">
                {isSelf ? (
                  ...
                  <div className="flex justify-end gap-1">
                    ...
                    {/* Lối thoát khi mật khẩu tạm đã mất. Đặt CẠNH các thao tác
                        khác chứ không giấu sau một menu ba chấm: người đi tìm nó
                        đang ở trong tình huống hỏng việc, không nên phải đoán
                        xem nó nằm đâu. */}
                    <Button
                      size="sm"
                      variant="ghost"
